package Net::Google::RestApi::OAuth2;
...
Net::Google::RestApi::OAuth2 - OAuth2 support for Google Rest APIs
...
Net::Google::RestAPI::OAuth2 interacts with google OAuth 2.0 service
...
L<Net::Google::DataAPI::Auth::OAuth2>
