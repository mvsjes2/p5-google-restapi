package Net::Google::RestApi::SheetsApi4;
...
sub drive {
  my $self = shift;
  if (!$self->{drive}) {
    require Net::Google::RestApi::DriveApi3;  # doesn't support 'aliased'
...
Net::Google::RestApi::SheetsApi4 - Perl API to Google Sheets API V4.
...
The synopsis above is a quick reference. For more detailed information, see:
 ...
 Net::Google::RestApi
 Net::Google::RestApi::SheetsApi4::Spreadsheet
 Net::Google::RestApi::SheetsApi4::Worksheet

=head1 SUBROUTINES

=over

=item new(api => <Net::Google::RestApi>);
