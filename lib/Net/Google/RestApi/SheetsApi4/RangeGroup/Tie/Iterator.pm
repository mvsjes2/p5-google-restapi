package Net::Google::RestApi::SheetsApi4::RangeGroup::Tie::Iterator;
...
use parent qw(Net::Google::RestApi::SheetsApi4::RangeGroup::Iterator);
...
Net::Google::RestApi::SheetsApi4::RangeGroup::Tie::Iterator - Perl API to Google Sheets API V4.
