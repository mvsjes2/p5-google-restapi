package Net::Google::RestApi::SheetsApi4::RangeGroup::Tie;
...
use aliased 'Net::Google::RestApi::SheetsApi4::RangeGroup::Tie::Iterator';
...
Net::Google::RestApi::SheetsApi4::RangeGroup::Tie - Perl API to Google Sheets API V4.
