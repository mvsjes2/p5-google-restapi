package Net::Google::RestApi::SheetsApi4::Range;
...
use aliased 'Net::Google::RestApi::SheetsApi4::Range::Iterator';

use Net::Google::RestApi::Utils qw(named_extra dim dims dims_all);

use parent "Net::Google::RestApi::SheetsApi4::Request::Spreadsheet::Worksheet::Range";
...
Net::Google::RestApi::SheetsApi4::Range - Perl API to Google Sheets API V4.
