package Net::Google::RestApi::SheetsApi4::Spreadsheet;
...
use Net::Google::RestApi::Utils qw(named_extra);
use aliased 'Net::Google::RestApi::SheetsApi4';
use aliased 'Net::Google::RestApi::SheetsApi4::Worksheet';
use aliased 'Net::Google::RestApi::SheetsApi4::RangeGroup';

use parent "Net::Google::RestApi::SheetsApi4::Request::Spreadsheet";
...
sub tie {
  ...
  my %ranges = @_;
  tie my %tie,
    'Net::Google::RestApi::SheetsApi4::RangeGroup::Tie', $self;
...
Net::Google::RestApi::SheetsApi4::Spreadsheet - Perl API to Google Sheets API V4.
...
See also Net::Google::RestApi::SheetsApi4::Worksheet::tie.
