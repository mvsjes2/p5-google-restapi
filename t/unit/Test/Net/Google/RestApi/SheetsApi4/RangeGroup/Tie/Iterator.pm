package Test::Net::Google::RestApi::SheetsApi4::RangeGroup::Tie::Iterator;

use Test::Most;
use YAML::Any qw(Dump);

use parent 'Test::Net::Google::RestApi::SheetsApi4::Base';

sub class { 'Net::Google::RestApi::SheetsApi4::RangeGroup::Tie::Iterator' }
