package Test::Net::Google::RestApi::SheetsApi4::Worksheet;
...
use parent qw(Test::Class Test::Net::Google::RestApi::SheetsApi4::Base);

sub class { 'Net::Google::RestApi::SheetsApi4::Worksheet' }
