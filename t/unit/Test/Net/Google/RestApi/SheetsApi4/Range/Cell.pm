package Test::Net::Google::RestApi::SheetsApi4::Range::Cell;

use Test::Most;

use parent qw(Test::Class Test::Net::Google::RestApi::SheetsApi4::Range::Base);

sub class { 'Net::Google::RestApi::SheetsApi4::Range::Cell' }
